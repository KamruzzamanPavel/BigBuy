...
const Navbar = () => {
  ...
  return (
    <nav className="grid grid-cols-2 p-4 border-b font-bold h-18">
      <h1 className="font-bold text-3xl flex items-center justify-start px-4 tracking-wider text-slate-800">
